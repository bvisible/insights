...
# //// Neoffice — guarded import. Our Frappe v15 fork predates Pulse telemetry, which
# //// frappe/frappe added in a later v15 release, and this module is the entry point
# //// of a daily scheduler job: a bare import would fail every day. Without Pulse there
# //// is nowhere to send the scan, so it reports telemetry as off and does nothing.
# //// Drop once our frappe fork carries frappe.utils.telemetry.is_pulse_enabled.
try:
...
# the chart types this version draws. version-3 declares them in the browser,
# `frontend/src2/types/chart.types.ts`; the backend has no list of its own
CHART_TYPES = ("Number", "Bar", "Line", "Row", "Donut", "Funnel", "Table", "Map", "Bubble", "Sankey")
