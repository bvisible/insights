...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    //// Neoffice — NOT an intentional change: this file is regenerated by
    //// unplugin-vue-components, and our build dropped the stale Autocomplete /
    //// Popover entries whose .vue files upstream had already deleted. Take
    //// upstream's version at the merge — the plugin rewrites it anyway.
    ...
    //// Neoffice — same regeneration drift as above (stale Popover entry gone).
